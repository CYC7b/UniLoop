            ...
            <div className="px-4 mt-4">
                <div className="bg-[#C07040] px-6 pt-8 pb-8 rounded-[2.5rem] shadow-[0_12px_30px_rgba(192,112,64,0.25)] relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-5 relative z-10">
                        <img src={profile.avatar_url || '/default-avatar.svg'} alt="avatar" className="w-20 h-20 rounded-full object-cover border-[3px] border-white/80 shadow-[0_8px_16px_rgba(0,0,0,0.1)]" />
